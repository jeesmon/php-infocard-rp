...
require_once 'InfoCard/Zend_InfoCard_Xml_Security_Transform_EnvelopedSignature.php';
require_once 'InfoCard/Zend_InfoCard_Xml_Security_Transform_XmlExcC14N.php';
...
class Zend_InfoCard_Xml_Security_Transform
{
    ...
    protected function _findClassbyURI($uri)
    {
        switch($uri) {
            ...
            default:
                throw new Exception("Unknown or Unsupported Transformation Requested");
        }
    }
